    ...
    public void tampil_database() {
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                crud.setName(hasil.getString("nama"));
                crud.setAlamat(hasil.getString("alamat"));
                String[] data = {crud.getId(), crud.getName(), crud.getAlamat()};
                tabmode.addRow(data);
            }
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {
        if (txt_id.getText().trim().equals("")) {
            ...
            try {
                ...
                crud.setName(txt_nama.getText());
                crud.setAlamat(txt_alamat.getText());
                crud.simpanData(crud.getId(), crud.getName(), crud.getAlamat());
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {
        if (txt_id.getText().trim().equals("")) {
            ...
            try {
                ...
                crud.setName(txt_nama.getText());
                crud.setAlamat(txt_alamat.getText());
                crud.ubahData(crud.getId(), crud.getName(), crud.getAlamat());
